    ...
    <FormGroup>
        ...
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <Input
            ...
            name="mail"
            id="mail"
            innerRef={emailInputRef} // Usamos innerRef en lugar de ref para acceder al DOM nativo
            value={formData.mail} // Mostrar solo la parte que el usuario escribe
            onChange={handleEmailChange}
            onFocus={handleEmailFocus} // Mantener el cursor antes de @byraices.com
            required
            style={{ width: 'auto', flex: '1' }} // Asegurar que solo ocupe la parte antes de @
          />
          <span style={{ paddingLeft: '5px' }}>@byraices.com</span> {/* Parte fija que no se puede modificar */}
        </div>
      </FormGroup>
...
<FormGroup>
  ...
  />
      ...
      <FormGroup>
  <Label for="martillerId">Martiller ID</Label>
  <Input
    type="select"
    name="martillerId"
    id="martillerId"
    ...
    required
  >
    <option value="">Selecciona un Martiller</option> {/* Opción por defecto */}
